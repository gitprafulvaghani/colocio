...
type RouteParams = {  };
type RouteId = '/(non-dashboard)/onboarding';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/(non-dashboard)/onboarding/+page.server.js').load>>>>>>;
