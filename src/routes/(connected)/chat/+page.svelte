...
<main>
  <div class="mx-auto flex h-screen max-w-3xl flex-col justify-end py-10">
    ...
    >
      <input
        ...
        bind:value={query}
        disabled={loading}
        class=" w-full rounded-lg border-white bg-transparent text-white
          shadow-sm ring-1 ring-inset ring-gray-300 transition-shadow
          focus:border-white focus:shadow-[0_0_0_4px] focus:shadow-white/25
          focus:ring-1 focus:ring-inset focus:ring-white sm:leading-6"
      />
