  ...
  <div class="flex lg:flex-row flex-col sm:gap-[16px] gap-3 mt-5">
    <div class="lg:w-[77%] w-full">
      <div class="flex items-start gap-1">
        ...
        <div>
          <h2 class="text-[#0D64E8] text-[18px] font-semibold leading-[21px]">
            Improve with Colocio:
          </h2>
          <p class="text-[#0D64E8] text-[12px] mt-[2px]">
      ...
      <div
        class="bg-[#E4EFFF] rounded-[12px] flex justify-between items-center p-4 my-[16px]"
      >
        <div class="flex items-start gap-[12px]">
          ...
          >
            <path
              d="M13.9959 17.4972H6.27423C5.76953 17.4972 5.51718 17.4972 5.40032 17.3973C5.29893 17.3107 5.24513 17.1808 5.25559 17.0479C5.26764 16.8946 5.44608 16.7162 5.80296 16.3592L12.8867 9.27445C13.2166 8.94449 13.3816 8.7795 13.5718 8.71769C13.7392 8.66331 13.9194 8.66331 14.0867 8.71769C14.2769 8.7795 14.4419 8.94449 14.7718 9.27445L17.9947 12.4979V13.4977M13.9959 17.4972C15.3956 17.4972 16.0955 17.4972 16.6301 17.2247C17.1004 16.9851 17.4827 16.6027 17.7223 16.1323C17.9947 15.5976 17.9947 14.8976 17.9947 13.4977M13.9959 17.4972H6.99788C5.59815 17.4972 4.89829 17.4972 4.36366 17.2247C3.89339 16.9851 3.51104 16.6027 3.27143 16.1323C2.99902 15.5976 2.99902 14.8976 2.99902 13.4977V6.4987C2.99902 5.09877 2.99902 4.3988 3.27143 3.8641C3.51104 3.39376 3.89339 3.01136 4.36366 2.77171C4.89829 2.49927 5.59815 2.49927 6.99788 2.49927H13.9959C15.3956 2.49927 16.0955 2.49927 16.6301 2.77171C17.1004 3.01136 17.4827 3.39376 17.7223 3.8641C17.9947 4.3988 17.9947 5.09877 17.9947 6.4987V13.4977M9.24724 7.08195C9.24724 8.0023 8.50126 8.74839 7.58105 8.74839C6.66084 8.74839 5.91486 8.0023 5.91486 7.08195C5.91486 6.16161 6.66084 5.41552 7.58105 5.41552C8.50126 5.41552 9.24724 6.16161 9.24724 7.08195Z"
              stroke="#0D64E8"
          ...
          <div>
            <p class="text-[#0D64E8] text-[14px] font-medium">Media</p>
        ...
        >
          <path
            d="M6.33301 15.5985L11.4837 10.4985L6.33301 5.39845L7.9187 3.83179L14.6663 10.4985L7.9187 17.1651L6.33301 15.5985Z"
            fill="#0D64E8"
          />
        </svg>
      </div>
      <div
        class="shadow-[0px_4px_9px_0px_#00000014] bg-white rounded-xl mb-[16px] md:p-8 p-4"
      >
        <h1
          class="flex items-center gap-2.5 font-bold text-lg text-font_dark pb-[16px]"
        >
          <svg
            width="45"
            height="44"
        ...
        <hr class="bg-gray-200 h-[1px] mb-[16px]" />
        <h1 class="text-[14px] text-[#4B5563] font-semibold mb-2">Platforms</h1>
      ...
      <div
        class="shadow-[0px_4px_9px_0px_#00000014] bg-white rounded-xl mt-[20px] mb-[16px] md:p-8 p-4"
      >
        <h1
          class="flex items-center gap-2.5 font-bold text-lg text-font_dark pb-[20px]"
        >
          <svg
            width="45"
            height="44"
        ...
        <hr class="bg-gray-200 h-[1px] mb-[20px]" />
        <div
          class="flex sm:flex-nowrap flex-wrap items-center sm:gap-[32px] gap-[18px] bg-blue-bglight text-blue-primary text-sm p-4 rounded-md"
        >
          <div class="flex-1">
          ...
          <button
            type="button"
            class="bg-blue-primary text-white py-2 px-3 flex items-center justify-center rounded-md sm:w-auto w-full text-center"
          >
        ...
        <button
          ...
          class="w-[120px] h-[120px] bg-transparent relative text-custom-gray-600 border border-dashed border-custom-gray-200 rounded-[10px] p-2.5 flex flex-col items-center justify-center mt-[20px]"
        >
          <svg
            width="27"
            height="27"
      ...
      <div
        class="shadow-[0px_4px_9px_0px_#00000014] bg-white rounded-xl mt-[20px] mb-[16px] md:p-8 p-4"
      >
        <h1 class="flex items-center gap-2.5 text-lg text-font_dark pb-[20px]">
          <svg
            width="45"
            height="44"
            viewBox="0 0 45 44"
        ...
        <hr class="bg-gray-200 h-[1px] mb-[20px]" />
        <div
          class="flex items-center text-sm text-center border-b border-gray-200 mb-3 mt-5"
        >
          <button
            type="button"
            on:click={() => {
        ...
        <div>
          {#if tab_selected === "facebook"}
            <div>
              <div class="bg-[#E4EFFF] p-[12px] rounded-md">
                <div class="flex gap-1">
                  <svg
                    class="min-w-4 h-4 mt-0.5"
                    width="17"
                    height="16"
                    viewBox="0 0 17 16"
                    fill="none"
                  ...
                  <div>
                    ...
                    <p class="text-[#0D64E8] text-[12px] font-medium">
                      Ask Colocio to write you an optimised description/caption
                      for you post, e.g. “Write me a caption promoting the
                      Monday Madness special the gives customers 50% off on all
                      item for this Monday only.”
                    </p>
                  </div>
                </div>
                <div
                  class="sm:p-[21px_8px_0_16px] flex sm:flex-row flex-col mt-[16px] gap-3"
                >
                  <textarea
                    id="colocio-prompt"
                    rows="2"
                  ...
                  <button
                    ...
                    class="bg-transparent border1 text-[#0D64E8] rounded-md sm:max-w-[90px] w-full h-[40px] gap-2 flex justify-center items-center"
                  >
                    Generate
                  </button>
                </div>
              ...
              <div class="mt-[20px]">
                <label
                  for=""
                  class="text-[#4B5563] text-[14px] w-full block font-medium"
                  >Description
                </label>
                ...
                <input
                  ...
                  type="text"
                  class="border-[#D1D5DB] border-[1px] h-[40px] w-full mt-1 rounded-md"
                />
              </div>
            </div>
          {/if}
          {#if tab_selected === "instagram"}
            <div>
              <label for="" class="text-[#4B5563] text-[14px] w-full block"
                >Post</label
              >
              <input
                type="text"
      ...
      >
        ...
        <div class="grid sm:grid-cols-2 gap-4">
          <div>
            <label for="start" class="font-medium text-[#4B5563] text-[14px]"
              >Start date/time</label
            >
            <div class="relative mt-1 datepicker-main">
              <!-- <input
                      type="text"
                      id="start"
