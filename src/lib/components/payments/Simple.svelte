<script land="ts">
  ...
  import { paymentSimpleID } from "$lib/stores/onboarding";
</script>
...
<svelte:head>
  ...
  <script
    async
    src="https://eu-test.oppwa.com/v1/paymentWidgets.js?checkoutId={$paymentSimpleID}/registration"></script>
</svelte:head>
...
>
  ...
  <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
    ...
    >
      ...
      >
        <p class="text-3xl text-blue-500 text-center">Simple Package</p>
        <br />
        <section
        ...
        <div class="rounded-xl ml-12 mr-12 p-5 border-2 border-gray-200">
          <div class="text-xl p-2">
            ...
            <div class="grid grid-cols-2">
              ...
              <div class="text-right text-sm sm:text-base">$49.00</div>
