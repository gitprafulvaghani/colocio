<script land="ts">
    ...
    import { paymentProID } from '$lib/stores/onboarding';
</script>
...
<svelte:head>
    ...
    <script
        async
        src="https://eu-test.oppwa.com/v1/paymentWidgets.js?checkoutId={$paymentProID}/registration"
    ></script>
</svelte:head>
...
>
    <div
        class="fixed inset-0 bg-[rgba(0, 0, 0, 0.12)] transition-opacity backdrop-blur-sm"
    ></div>
    ...
    <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
        ...
        >
            ...
            >
                <p class="text-3xl text-blue-500 text-center">
                    Pro Package
                </p>
                <br />
                <section
                    ...
                    <div class="flex-1 flex gap-1">
                        ...
                        <div>
                            ...
                            <div class="text-xs sm:text-sm text-gray-600">
                                Enter your card details and press <strong
                                    >Pay now</strong
                                >
                                to subscribe to the Colocio services. You will
                                sign up for the
                                <strong>Pro</strong> package.
                                <br /><br />
                                <strong>Note:</strong> All subscribtions are
                                processed in US Dollars ($) and is subject
                ...
                <br />
                <div
                    class="rounded-xl ml-12 mr-12 p-5 border-2 border-gray-200"
                >
                    <div class="text-xl p-2">
                        ...
                        <div class="grid grid-cols-2">
                            ...
                            <div
                                class="text-right font-semibold text-sm sm:text-base"
                            >
                                $208.00
                            </div>
                        </div>
