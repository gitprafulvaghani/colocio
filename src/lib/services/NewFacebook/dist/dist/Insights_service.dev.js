...
exports.getTopAdsData = exports.Optimalaudience = exports.getPageFanOnline = exports.getTargetingAudienceForAd = exports.getHourlyBreakDown = exports.GetPageProfilevisit = exports.GetPageunlikesandunfollows = exports.GetNewfollowers = exports.GetPageProfilevisits = exports.fetch_Priview_FacebookData = exports.fetchInstagramData = exports.fetchFacebookData = exports.GetInterestandBehaviourAudiences = exports.GetRegionandcountry = exports.GetAgeandGender = exports.page_fan_adds = exports.GrowthPageandProfile = exports.GetNewFollows = exports.GetLocationInsights = exports.getPlatfrom = exports.getInsights = exports.getAdsetInsightsPrevious = exports.getAdsetInsights = exports.getAdsetInsightsData = exports.GetInterestandBehaviour = exports.fetch_Tab_Performing = exports.fetchInsights = void 0;
...
exports.fetchInsights = fetchInsights; //---------------- performers api ----------------
...
exports.GetInterestandBehaviour = function () {
...
exports.getAdsetInsightsData = function () {
  return __awaiter(void 0, void 0, Promise, function () {
...
exports.getAdsetInsights = function (timePeriod) {
  return __awaiter(void 0, void 0, Promise, function () {
    var apiUrl, timeRange, currentDate, params, url, response, errorResponse, data, error_5;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          apiUrl = 'https://graph.facebook.com/' + envVariables_1.FB_API_VERSION + '/' + envVariables_1.AD_ACCOUNT_ID + '/insights';
          ...
          switch (timePeriod) {
            case '7days':
              timeRange = {
                since: new Date(currentDate.setDate(currentDate.getDate() - 7)).toISOString().split('T')[0],
            ...
            case '30days':
              timeRange = {
                since: new Date(currentDate.setDate(currentDate.getDate() - 30)).toISOString().split('T')[0],
                until: new Date().toISOString().split('T')[0]
              };
              break;
            ...
            case '6months':
              timeRange = {
                since: new Date(currentDate.setMonth(currentDate.getMonth() - 6)).toISOString().split('T')[0],
                until: new Date().toISOString().split('T')[0]
              };
              break;
            ...
            case '1year':
              timeRange = {
                since: new Date(currentDate.setFullYear(currentDate.getFullYear() - 1)).toISOString().split('T')[0],
                until: new Date().toISOString().split('T')[0]
              };
              break;
        ...
        case 6:
          error_5 = _a.sent();
          console.error('Error fetching adset insights:', error_5);
          throw error_5;
...
exports.getAdsetInsightsPrevious = function (timePeriod) {
  return __awaiter(void 0, void 0, Promise, function () {
    var apiUrl, previousDate, params, url, response, errorResponse, data, error_6;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          apiUrl = 'https://graph.facebook.com/' + envVariables_1.FB_API_VERSION + '/' + envVariables_1.AD_ACCOUNT_ID + '/insights';
        ...
        case 6:
          error_6 = _a.sent();
          console.error('Error fetching adset insights:', error_6);
          throw error_6;
...
function getInsights(type) {
  return __awaiter(this, void 0, void 0, function () {
    var ADUrl, paramsAD, PostUrl, paramsPOST, URL, response, data, error_7;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
        ...
        case 4:
          error_7 = _a.sent();
          console.error('Error fetching Facebook API:', error_7);
          throw error_7;
...
function getPlatfrom() {
  return __awaiter(this, void 0, void 0, function () {
    var apiUrl, params, url, response, data, error_8;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
        ...
        case 4:
          error_8 = _a.sent();
          console.error('Error fetching Facebook API:', error_8);
          throw error_8;
...
function GetLocationInsights() {
  return __awaiter(this, void 0, void 0, function () {
    var apiUrl, params, url, response, data, error_9;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          apiUrl = 'https://graph.facebook.com/' + envVariables_1.FB_API_VERSION + '/' + envVariables_1.AD_CAMPAIGN_ID_1 + '/insights';
...
function GetNewFollows(timePeriod) {
  return __awaiter(this, void 0, Promise, function () {
    var apiUrl, timeRange, params, url, response, data, error_10;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
...
function GrowthPageandProfile(timePeriod) {
  return __awaiter(this, void 0, Promise, function () {
    var apiUrl, timeRange, params, url, response, data, error_11;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          apiUrl = 'https://graph.facebook.com/' + envVariables_1.FB_API_VERSION + '/' + new_page_ID + '/insights';
...
function GetAgeandGender() {
  return __awaiter(this, void 0, void 0, function () {
    var apiUrl, params, url, response, data, error_13;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
...
function GetRegionandcountry() {
  return __awaiter(this, void 0, void 0, function () {
    var apiUrl, params, url, response, data, error_14;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          apiUrl = 'https://graph.facebook.com/' + envVariables_1.FB_API_VERSION + '/' + envVariables_1.AD_ACCOUNT_ID_1 + '/insights';
...
exports.GetInterestandBehaviourAudiences = GetInterestandBehaviourAudiences; // Campaign Engagements API

var fetchFacebookData = function fetchFacebookData(fbAccessToken, fbPageId, timePeriod) {
  return __awaiter(void 0, void 0, Promise, function () {
    var likesSummary, commentsSummary, sharesSummary, reelViewsSummary, reactionsSummary, Post_response, timeRang, newTimeRange, url, response, data, posts, error_16;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          likesSummary = {
        ...
        case 4:
          ...
          posts.forEach(function (post) {
            ...
            if (post.attachments && post.attachments.data.length > 0) {
              ...
              if (mediaType === 'video') {
                reelViewsSummary.instagram += ((_a = post.attachments.data[0].video_insights) === null || _a === void 0 ? void 0 : _a.video_view_count) || 0;
              }
            }
        ...
        case 6:
          error_16 = _a.sent();
          console.error('Error fetching Facebook data:', error_16);
          return [3
          /*break*/
          , 7];
...
var fetch_Priview_FacebookData = function fetch_Priview_FacebookData(fbAccessToken, fbPageId, timePeriod) {
  return __awaiter(void 0, void 0, Promise, function () {
    var likesSummary, commentsSummary, sharesSummary, reelViewsSummary, reactionsSummary, Post_response, timeRang, newTimeRange, url, response, data, posts, error_17;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          likesSummary = {
        ...
        case 6:
          error_17 = _a.sent();
          console.error('Error fetching Facebook data:', error_17);
          return [3
          /*break*/
          , 7];
...
var fetchInstagramData = function fetchInstagramData(igAccessToken, igPageId) {
  return __awaiter(void 0, void 0, Promise, function () {
    var likesSummary, commentsSummary, sharesSummary, reelViewsSummary, url, response, data, posts, error_18;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          likesSummary = {
        ...
        case 6:
          error_18 = _a.sent();
          console.error('Error fetching Instagram data:', error_18);
          return [3
          /*break*/
          , 7];
...
function GetPageProfilevisits(timePeriod) {
  return __awaiter(this, void 0, void 0, function () {
    var timeRang, apiUrl, params, url, response, data, error_19;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          timeRang = getTimeRange(timePeriod);
        ...
        case 4:
          error_19 = _a.sent();
          console.error('Error fetching Facebook API:', error_19);
          throw error_19;
...
function GetNewfollowers($timePeriod) {
  return __awaiter(this, void 0, void 0, function () {
    var apiUrl, params, url, response, data, error_20;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
        ...
        case 4:
          error_20 = _a.sent();
          console.error('Error fetching Facebook API:', error_20);
          throw error_20;
...
exports.GetNewfollowers = GetNewfollowers; //export async function GetPageunlikesandunfollows($timePeriod: string) {
...
function getHourlyBreakDown(week) {
  return __awaiter(this, void 0, void 0, function () {
    var apiUrl, params, currentDate, startOfWeek, endOfWeek, timeRange, url, response, data, error_23;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          apiUrl = 'https://graph.facebook.com/' + envVariables_1.FB_API_VERSION + '/' + envVariables_1.AD_CAMPAIGN_ID_1 + '/insights';
...
function getTargetingAudienceForAd(adsetId) {
  return __awaiter(this, void 0, void 0, function () {
    var URL, response, data, error_24;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
...
function getPageFanOnline() {
  return __awaiter(this, void 0, void 0, function () {
    var url, response, data, error_25;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
...
function Optimalaudience() {
  return __awaiter(this, void 0, void 0, function () {
    var timeRang, apiUrl, params, url, response, data, error_26;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
...
exports.Optimalaudience = Optimalaudience; //================================ Top Performing Attribute (Ads) ==================================

function getTopAdsData() {
  return __awaiter(this, void 0, void 0, function () {
    var url, response, data, error_27;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          url = 'https://graph.facebook.com/' + envVariables_1.FB_API_VERSION + '/' + envVariables_1.AD_ACCOUNT_ID_1 + '/ads?fields=name,creative{object_story_spec},insights{reach,impressions},adset{name,daily_budget,start_time,end_time,targeting},message&access_token=' + envVariables_1.T_TOKEN;
          _a.label = 1;
...
exports.getTopAdsData = getTopAdsData;