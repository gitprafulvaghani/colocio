import { SvelteComponent, init, safe_not_equal, create_slot, update_slot_base, get_all_dirty_from_scope, get_slot_changes, transition_in, transition_out, compute_rest_props, assign, exclude_internal_props, element, set_attributes, insert, get_spread_update, detach, binding_callbacks } from 'svelte/internal';
...
function fallback_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			set_attributes(input_1, input_data = get_spread_update(input_1_levels, [dirty & /*$$restProps*/ 2 && /*$$restProps*/ ctx[1]]));
		},
		d(detaching) {
			if (detaching) {
				detach(input_1);
