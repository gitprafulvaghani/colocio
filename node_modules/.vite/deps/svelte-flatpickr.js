...
function FlatpickrInstance(element2, instanceConfig) {
  ...
  function onKeyDown(e) {
    var eventTarget = getEventTarget(e);
    var isInput = self.config.wrap ? element2.contains(eventTarget) : eventTarget === self._input;
...
function fallback_block(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      set_attributes(input_1, input_data = get_spread_update(input_1_levels, [dirty & /*$$restProps*/
      2 && /*$$restProps*/
      ctx2[1]]));
    },
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$new_props) => {
    ...
    if ("element" in $$new_props) $$invalidate(5, element2 = $$new_props.element);
