...
/* src/GooglePlacesAutocomplete.svelte generated by Svelte v3.59.2 */
...
function create_fragment(ctx) {
	...
	return {
		c() {
			input = element("input");
			attr(input, "class", input_class_value = /*$$props*/ ctx[7].class);
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					...
					listen(input, "keydown", /*onKeyDown*/ ctx[6])
				];
